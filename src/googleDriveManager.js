...
class GoogleDriveManager {
    constructor(apiKey, clientId) {
        ...
        this.scope = "https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/drive.metadata.readonly";
    ...
    showFolderPicker(callback) {
        ...
        // To ensure only folders are selectable and shown
