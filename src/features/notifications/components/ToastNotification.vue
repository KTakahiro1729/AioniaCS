...
<style scoped>
.toast {
  background: linear-gradient(135deg, var(--color-panel-header) 0%, rgb(42 42 42 / 95%) 100%);
...
.toast--error::before {
  background: linear-gradient(180deg, var(--color-error) 0%, var(--color-error-light) 100%);
...
.toast--info .toast-icon {
  ...
  color: var(--color-info-glow);
  box-shadow: 0 0 6px var(--color-info-glow);
}
...
.toast-progress {
  ...
  left: 0;
  height: 3px;
  background: linear-gradient(90deg, rgb(192 154 105 / 80%) 0%, rgb(228 202 168 / 60%) 50%, rgb(192 154 105 / 40%) 100%);
