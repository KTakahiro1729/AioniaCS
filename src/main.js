  ...
  methods: {
    ...
    removeSpecialSkill(index) {
      if (this.specialSkills.length > 1) {
        ...
        this.specialSkills.length === 1 &&
        this.hasSpecialSkillContent(this.specialSkills[index])
      ) {
    ...
    addHistoryItem() {
      this.histories.push({ sessionName: "", gotExperiments: null, memo: "" });
    },
    removeHistoryItem(index) {
      if (this.histories.length > 1) {
        ...
        this.hasHistoryContent(this.histories[index])
      ) {
    ...
    saveData() {
      this.dataManager.saveData(
        ...
        this.equipments,
        this.histories,
        (message) => this.showCustomAlert(message),
      );
    },
