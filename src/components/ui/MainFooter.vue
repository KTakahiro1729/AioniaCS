<template>
  ...
  <div :class="['status-display', experienceStatusClass]">
      {{ experienceLabel }} {{ currentExperiencePoints }} / {{ maxExperiencePoints }}
    </div>
    <div class="footer-button-container">
      <button
        ...
        :title="saveTitle"
      >
        <span class="icon-svg icon-svg--footer" :class="saveIcon"></span>
        {{ saveLabel }}
      </button>
    </div>
    <div class="footer-button-container">
      <label
        ...
        :title="loadTitle"
      >
        <span class="icon-svg icon-svg--footer" :class="loadIcon"></span>
        {{ loadLabel }}
      </label>
      <input
        type="file"
