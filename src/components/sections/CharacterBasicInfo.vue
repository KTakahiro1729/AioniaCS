      ...
      <div class="info-row">
        ...
        <div class="info-item info-item--double" v-if="characterStore.character.species === 'other'">
          ...
          <input
            type="text"
            id="rare_species"
            v-model="characterStore.character.rareSpecies"
            :disabled="uiStore.isViewingShared"
          />
        </div>
      </div>
      <div class="info-row">
        <div class="info-item info-item--quadruple">
          ...
          <input
            type="text"
            id="gender"
            v-model="characterStore.character.gender"
            :disabled="uiStore.isViewingShared"
          />
        </div>
        <div class="info-item info-item--quadruple">
          ...
          <input
            type="number"
            id="age"
            v-model.number="characterStore.character.age"
            min="0"
            :disabled="uiStore.isViewingShared"
          />
        </div>
      ...
      <div class="info-row">
        <div class="info-item info-item--triple">
          ...
          <input
            type="text"
            id="origin"
            v-model="characterStore.character.origin"
            :disabled="uiStore.isViewingShared"
          />
        </div>
        <div class="info-item info-item--triple">
          ...
          <input
            type="text"
            id="occupation"
            v-model="characterStore.character.occupation"
            :disabled="uiStore.isViewingShared"
          />
        </div>
        <div class="info-item info-item--triple">
          ...
          <input
            type="text"
            id="faith"
            v-model="characterStore.character.faith"
            :disabled="uiStore.isViewingShared"
          />
        </div>
      </div>
